  ...
  <div class="vid-parent">
    ...
    <div class="vid-overlay">
      <div class="vid-content">
        <h1 class="my-content">Welcome to EduCentre</h1>
...
<div class="container-fluid p-4" style="background-color:#E9ECEF">
  <div class="container" style="background-color:#E9ECEF">
    <div class="row text-center">
      <div class="col-sm">
        <h5>About Us</h5>
        <p>EduCentre provides universal access to the world’s best education, partnering with top universities and organizations to offer courses online.</p>
      </div>
      <div class="col-sm">
        <h5>Category</h5>
      ...
      <div class="col-sm">
        <h5>Contact Us</h5>
        <p>EduCentre Pvt Ltd <br> Near Airport Gandhi Nagar <br> Bhopal, Madhya Pradesh <br> Ph. 000000000 </p>
      </div>
    </div>
  </div>
