...
?>
    <div class="container-fluid bg-dark"> <!-- Start Course Page Banner -->
      <div class="row">
        <img src="./image/ban2.jpg" alt="courses" style="height:500px; width:100%; object-fit:cover; box-shadow:10px;"/>
      </div>
              ...
              echo '
                <div class="col-sm-4 mb-4">
                  <a href="coursedetails.php?course_id='.$course_id.'" class="btn" style="text-align: left; padding:0px;"><div class="card">
                    <img src="'.str_replace('..', '.', $row['course_img']).'" class="card-img-top" alt="Guitar" width="140px" height="140px"/>
                    <div class="card-body">
                      <h5 class="card-title">'.$row['course_name'].'</h5>
                      <p height="100px" class="card-text">'.$row['course_desc'].'</p>
                    </div>
